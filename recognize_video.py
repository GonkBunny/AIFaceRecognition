...
if __name__ == "__main__":
    ...
    ap.add_argument("-d", "--detector", required=True, help="path to g face detector")
    ...
    ap.add_argument("-c", "--confidence", type=float, default=0.5, help="minimum probability to filter bellow detections")
